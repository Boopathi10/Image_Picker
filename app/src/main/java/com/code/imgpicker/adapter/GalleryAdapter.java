package com.code.imgpicker.adapter;
...
import com.code.imgpicker.ImgBottomSheetDialogFragment;
import com.code.imgpicker.R;
import com.code.imgpicker.view.SquareFrameLayout;
import com.code.imgpicker.view.SquareImageView;
...
public class GalleryAdapter extends RecyclerView.Adapter<GalleryAdapter.GalleryViewHolder> {
    ...
    private ImgBottomSheetDialogFragment.BaseBuilder builder;
    private OnItemClickListener onItemClickListener;
    private List<Uri> selectedUriList;


    public GalleryAdapter(Context context, ImgBottomSheetDialogFragment.BaseBuilder builder) {
        ...
        try {
            ...
            String orderBy;
            Uri uri;
            if (builder.mediaType == ImgBottomSheetDialogFragment.BaseBuilder.MediaType.IMAGE) {
